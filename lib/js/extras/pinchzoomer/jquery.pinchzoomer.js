...
(function(window, $)
{
	...
	var ElemZoomer = function(elemHolderParam, elemParam, markersParam, varsParam)
	{
        ...
        o.goReturn = function(){
            ...
            return {epX:elemPosX,epY:elemPosY,curX:curX,curY:curY,sZPos:setZoomPosition,olW:oldWidth,olH:oldHeight,oldX:oldX,oldY:oldY,adjPos:adjustPosition,cenX:centerX,cenY:centerY,curWidth:curWidth,curHeight:curHeight,hZoom:handleZoom,updateElemPos:updateElemPos,endZoom:endZoom,onMouseWheel:onMouseWheel}
        }
		...
		function onZoomComplete()
		{
			...
			{
				/* Add OnComplete */
				_vars.onComplete(zoomComplete)
				TweenLite.set(_elem, {imageRendering: "auto", rotation:0});
                //TweenLite.set(_elem, {rotation:0});
                if(isBuggySamsung)
                {
                    handleMarkerZoom();
                }
        ...
        function handleZoom(duration)
		{
			if(_elem != null)
			{
                curZoom = Math.round(curZoom * 100000) / 100000;
				duration = !isNaN(duration) ? duration : _vars.animDuration;
				//zoomObj = { scale:zoom, x:curX, y:curY, force3D:_vars.force3D, rotation:0.01, immediateRender:false, onComplete:onZoomComplete };
...
(function(window, $)
{
	...
	PinchZoomer.defaultVars = $.extend({}, ElemZoomer.defaultVars, { appendControls:true, appendControlHolder:true, fullscreenDivCss:"fullscreenDiv", fullscreenScaleMode:"proportionalInside", preloaderUrl:"assets/img/preloader.gif", preload:true, initFullscreen:false });
